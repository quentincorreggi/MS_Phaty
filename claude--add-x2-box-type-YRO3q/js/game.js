...
function initGame() {
  ...
  for (var r = 0; r < L.rows; r++) for (var c = 0; c < L.cols; c++) {
    ...
    if (tSlot) {
      ...
      var boxMrbTotal = isX2 ? MRB_PER_BOX * 2 : MRB_PER_BOX;
      stock.push({ ci: slot.ci, used: false, remaining: boxMrbTotal, marblesTotal: boxMrbTotal, spawning: false, spawnIdx: 0,
