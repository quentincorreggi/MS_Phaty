// ============================================================
// box_layered_blocker.js — Layered Blocker box type
// Same as blocker but the stone-marble clear resets every 9
// marbles instead of triggering once for all stone marbles.
// ============================================================

registerBoxType('layered_blocker', {
  label: 'Layered',
  editorColor: '#6A6058',
