...
var sfx = {
  ...
  stoneClack: function () { tone(180, 0.07, 'square', 0.06, 90); setTimeout(function () { tone(130, 0.05, 'sine', 0.04, 60); }, 18); },
  stoneCharge: function () { tone(220, 0.35, 'sawtooth', 0.06, 520); },
  stoneShatter: function () {
    [180, 140, 110, 90, 70].forEach(function (f, i) { setTimeout(function () { tone(f, 0.18, 'square', 0.08, f * 0.55); }, i * 35); });
    setTimeout(function () { tone(900, 0.25, 'sine', 0.07, 200); }, 80);
  }
};
