...
function spawnPhysMarbles(box) {
  ...
  var mrbTotal = box.marblesTotal || MRB_PER_BOX;
  var blockerStart = mrbTotal - blockerCount;
  for (var idx = 0; idx < count; idx++) {
    (function (i, b, bStart, bTotal) {
      setTimeout(function () {
        if (b.remaining <= 0) return;
        var spawnIdx = (bTotal - b.remaining) % SNAKE_ORDER.length;
