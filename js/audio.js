...
var sfx = {
  ...
  shake: function () {
    // Whoosh up
    tone(200, 0.3, 'sawtooth', 0.08, 800);
    // Rattle hits
    setTimeout(function () { tone(1200, 0.06, 'square', 0.06); }, 50);
    setTimeout(function () { tone(900, 0.06, 'square', 0.05); }, 100);
    setTimeout(function () { tone(1400, 0.06, 'square', 0.05); }, 150);
    setTimeout(function () { tone(1100, 0.08, 'square', 0.04); }, 200);
  }
};
